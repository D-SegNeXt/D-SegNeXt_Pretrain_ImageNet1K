...
#In a single layer, kernel with different sizes is used to obtain features with different scales.
# Multi-branch Depth Separable Strip Convolution Captures Multi-scale Context Information
class AttentionModule(BaseModule):
    def __init__(self, dim):
        super().__init__()
        self.conv0 = nn.Conv2d(dim, dim, 5, padding=2, groups=dim)#Aggregate local information
        #3 branches
        ...
        self.conv3 = nn.Conv2d(dim, dim, 1)# 1 × 1 convolution to capture relationships between different channels
